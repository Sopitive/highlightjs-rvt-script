/*! `rvt-script` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict";return e=>{let _=e.COMMENT("--","$");return{
case_insensitive:!0,keywords:{
keyword:"for alt altif enum declare each do on function end alias then if local high with label and",
literal:"true false none"},
contains:[e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,e.C_NUMBER_MODE,_,{
className:"string",begin:'"',end:'"',contains:[e.BACKSLASH_ESCAPE]},{
className:"variable",begin:/alias /,excludeBegin:!0,end:/\w+\s/},{
className:"type",
...
excludeEnd:!0},{className:"functionCall",begin:/(\s+|)\w+\(/,keywords:{
...
}},{className:"property",begin:/\.\w+\s/,keywords:{
...
}},{className:"symbol",begin:/[^A-Za-z0-9\n _-]/}]}}})()
;hljs.registerLanguage("rvt-script",e)})();