     ...
     contains:
       [
         ...
         COMMENTS,
         {
          ...
          {
           className: 'type',
           begin: /\.(number|object|team|timer)|script_option|script_traits|script_stat|script_widget/,
         },
         {
          className: 'title',
